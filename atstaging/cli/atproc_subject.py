...
def parse(arguments=None):
    ...
    parser.add_argument('--amyloid', required=True, dest='amyloid_img', help='Input aymloid PET image to preprocess.')
    parser.add_argument('--amyloid-tracer', required=True, dest='amyloid_tracer', help='Tracer code for amyloid PET image')
    parser.add_argument('--tau', required=True, dest='tau_img', help='Input tau PET image to preprocess.')
    parser.add_argument('--tau-tracer', required=True, dest='tau_tracer', help='Tracer code for tau PET image')
