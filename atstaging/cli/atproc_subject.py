...
def parse(arguments=None):
    ...
    parser.add_argument('--amyloid', required=False, dest='amyloid_img', help='Input aymloid PET image to preprocess.', default=None)
    parser.add_argument('--amyloid-tracer', required=False, dest='amyloid_tracer', help='Tracer code for amyloid PET image', default=None)
    parser.add_argument('--tau', required=False, dest='tau_img', help='Input tau PET image to preprocess.', default=None)
    parser.add_argument('--tau-tracer', required=False, dest='tau_tracer', help='Tracer code for tau PET image', default=None)
    parser.add_argument('--config', required=False, help='Configuration file name (.json) not required.', default=None)
