...
plt.savefig(os.path.join(savedir, 'colorbar.svg'))
...
array_val_path_AMY = [valA_amy_path, valB_amy_path, valC_amy_path]
array_val_path_TAU = [valA_tau_path, valB_tau_path, valC_tau_path]
array_val_indices_AMY = [valA_amy_indices, valB_amy_indices, valC_amy_indices]
array_val_indices_TAU = [valA_tau_indices, valB_tau_indices, valC_tau_indices]

# AMYLOID
set_font_properties(8)
fig, axes = plt.subplots(nrows=1, ncols=3, figsize=(6.5, 3), dpi=300, sharey=True,
...
plt.tight_layout()
plt.savefig(os.path.join(savedir, 'amyloid_validation_subsets_compare.svg'))

# TAU
fig, axes = plt.subplots(nrows=1, ncols=3, figsize=(6.5, 3.5), dpi=300, sharey=True,
...
plt.tight_layout()
plt.savefig(os.path.join(savedir, 'tau_validation_subsets_compare.svg'))
