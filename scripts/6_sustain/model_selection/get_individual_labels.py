...
vmodel_predictions = validation_sustain.predict(wdata, n_subtypes=3, prefix='Validation')[['ValidationMLSubtype', 'ValidationMLStage', 'ValidationMLSubtypeRAW', 'ValidationSubtypeValid']]
